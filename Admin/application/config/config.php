...
|
*/
$config['encryption_key'] = 'Go87NSzqqq95Dq2jcjnvhVUCpKPeP3ea';
...
$config['sess_cookie_name'] = 'admin_sg365_session';
...
$config['cur_tag_open'] = '<span><li class="fg-button ui-button ui-state-default ui-state-disabled">';
